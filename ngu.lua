 ...
 while wait() do
    ...
    while wait() do
     pcall(function ()
        ...
        part.CFrame = CFrame.new(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.X, game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Y - 4, game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Z)
        end)
    end
end
end)
...
local Window = Library:CreateWindow({
    Title = '[Kaitan] Sera.ph | https://seraph.gq/ ',
    Center = true, 
    AutoShow = true,
})
local Tabs = {
...
Info:AddLabel("Welcome To sera.ph v2 Premuim")
...
Kaitan:AddButton('CapCut Picture Kaitan', function()
    local cac = require(game:GetService("Players").LocalPlayer.PlayerGui.Main.UIController.Inventory)
		...
		for k,v in pairs(allitem) do 
			...
			local cac2 = Instance.new("Fram6e",Right)
            ...
            if getgenv().FullySuprtHuman then
                ...
                if
                 ...
                 then
                    ...
                    if getgenv().FullySuprtHuman and game.Players.LocalPlayer.Data.Fragments.Value < 1500 and not OldWolrd then
...
task.spawn(
                                            ...
                                            if
                                             ...
                                             then
                                                repeat
                                                    ...
                                                    StartMagnet = true
                                                until not getgenv().LevelFarm or v.Humanoid.Health <= 0 or not v.Parent or checkquest2() == false
                                            else
                                                StartMagnet = true
                                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(
                                                    "AbandonQuest"
	...
	spawn(function()
	  ...
	  while wait() do
	   if game:GetService("Players").LocalPlayer.Data.Level.Value > 119 and game:GetService("Players").LocalPlayer.Data.Level.Value < 315 then
getgenv ().LevelFarm = false
if game.Players.LocalPlayer.Data.Level.Value == 300 then 

							  wait(10)

							  game.Players.LocalPlayer:Kick('seraph | hop')
							  end
...
--print('c')
						...
						if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,v.Name) and v ~= kill2 then 
												 a = 0
 countkill = countkill + 1
  ...
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
	--					print(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,v.Name)
...
a = a + 1
				--				print(a)
								...
								TweenFarm(v.HumanoidRootPart.CFrame)
								AutoHaki()
								end)
								 if (v:WaitForChild('HumanoidRootPart').CFrame.Position - game.Players.LocalPlayer.Character:WaitForChild('HumanoidRootPart').CFrame.Position).Magnitude < 50 then
								v.HumanoidRootPart.Size = Vector3.new(60,60,60)
								getgenv().atk = true
								end
							until not v or v.Humanoid.Health <= 0 or a == 360
							getgenv().atk = false
							kill2 = v
							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest") 
						end
					end
if countkill >= #game.Players:GetPlayers()  then
game.Players.LocalPlayer:Kick('Hop')
				end
			end
	   end end
	 end
...
--print(Lv, Saber)
wait (1)
        if Lv >= 200 and Saber ~= true then
getgenv().stus.item.first = "Collecting Saber"
getgenv().busy = true
 getgenv().LevelFarm = false
print(2, getgenv().LevelFarm)
getgenv().farmmode = ""
         --   print('a')
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress","SickMan") ~= 0 then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                getgenv().stus.item.aredo = 'Check SickMan Quest'
           --     print('b')
                getgenv().LevelFarm = false
print(3, getgenv(). LevelFarm)
                repeat wait()
                TweenFarm(CFrame.new(-1609.29956, 40.0520697, 162.820404))
                getgenv().stus.item.aredo = 'Tweeening To QuestPlace'
            ...
            --    print ('f')
                for i,v in pairs(game:GetService("Workspace").Map.Jungle.QuestPlates:GetChildren()) do
                 getgenv().stus.item.aredo = 'Activing The Plate'
                    if v.Name == "Plate1" then
                        repeat wait()
                        TweenFarm(v.Button.CFrame)
                ...
                repeat wait()
                    equipWeapon("Torch")
                    TweenFarm(CFrame.new(1113.9502, 4.92147732, 4350.91992, -0.60768199, 3.86533046e-08, 0.794180453, 6.00742425e-08, 1, -2.70375722e-09, -0.794180453, 4.60667628e-08, -0.60768199))
                ...
                repeat wait()
                    equipWeapon("Cup")
                    getgenv().stus.item.aredo = 'Collecting Cup'
                    TweenFarm(CFrame.new(1397.73975, 37.3480263, -1321.54456, -0.170597032, -4.99889588e-08, 0.985340893, 2.99880867e-08, 1, 5.59246409e-08, -0.985340893, 3.90890662e-08, -0.170597032))
                ...
                wait(1)
                getgenv().stus.item.aredo = 'Getting Water To Sick Man'
...
spawn(function()
   ...
   --  print(1)
        if Mob_Boss then
         getgenv().stus.item.aredo = 'Talk To Rich Son'
--print(2)
...
--print (4)
                    ...
                    repeat wait()
                        print(5)
                        getgenv().stus.item.aredo = 'Unlocking Door'
                        equipWeapon("Relic")
                        TweenFarm(CFrame.new(-1406.60925, 29.8520069, 4.5805192, 0.882920146, 3.62382622e-08, 0.469523162, -3.61928865e-09, 1, -7.03750587e-08, -0.469523162, 6.04362143e-08, 0.882920146))
                    until (Vector3.new(-1406.60925, 29.8520069, 4.5805192)-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 10
                    wait(1)
                    Saber_Kill = true
                    Mob_Boss = false
                else
...
--print(7)  
getgenv().stus.item.aredo = 'Killing Mob Leader [Lv. 120]'
                ...
                elseif game:GetService("ReplicatedStorage"):FindFirstChild("Mob Leader [Lv. 120] [Boss]") then
                    TweenFarm(game:GetService("ReplicatedStorage"):FindFirstChild("Mob Leader [Lv. 120] [Boss]").HumanoidRootPart.CFrame)
                end
            else
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress","RichSon")
                Saber_Kill = true
...
spawn(function()
    ...
    while wait(.2) do
        ...
        spawn(function()
            if Saber_Kill then
--print('972774')
           getgenv().stus.item.aredo = 'Killing NoHand Guy'
                    ...
                    for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                        if v.Name == "Saber Expert [Lv. 200] [Boss]" then
                            ...
                            repeat wait()
                               equip('Melee')
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                TweenFarm(v.HumanoidRootPart.CFrame*CFrame.new(0,25,15))
                                getgenv().atk = true
...
getgenv().stus.item = {}
                ...
                elseif game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert [Lv. 200] [Boss]") or game.Workspace.Enemies:FindFirstChild("Saber Expert [Lv. 200] [Boss]") then
                    TweenFarm(game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert [Lv. 200] [Boss]").HumanoidRootPart.CFrame)
...
spawn(function ()
 while wait() do
 if not game.Workspace.Enemies:FindFirstChild("Saber Expert [Lv. 200] [Boss]") and not game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert [Lv. 200] [Boss]") and Saber_Kill then
getgenv().stus.item.aredo = "Undetected NoHand Guy, Hopping In 5s"
 wait(5)
                        game.Players.LocalPlayer:Kick('seraph | hop(process:getting saber - killing saber expert)')
...
spawn(function()
 while wait() do
  if getgenv().busy == false then
    if MyLevel ~= nil and MyLevel < 90 and MyLevel > 29 then
     print('noquest')
...
print('lvfarm2')
    ...
    elseif MyLevel < 30 then
        getgenv().farmmode = "Level Farm"
        print('lvfarm3')
    elseif MyLevel > 119 and MyLevel < 2300 then
     getgenv().farmmode = ""
        end
    ...
    while wait() do
        if  getgenv().LevelFarm then
			if getgenv().farmmode == "Level Farm" then
			  	spawn(function()
			  		if not string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) and arefarm then
			  			StartMagnet = false
			  			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
			  		end
			  		if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
			  			StartMagnet = false
			  			QuestCheck()
			  			repeat wait() TweenFarm(CFrameQuest) until (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 10 or not getgenv().LevelFarm
...
StartMagnet = false
			...
			elseif getgenv().farmmode == "Fast Mode" then
				spawn(function()
					if true then
...
elseif getgenv().farmmode == "Near Farm Mode" then
  for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
 ...
 v.HumanoidRootPart.Size = Vector3.new(60,60,60)
 StartMagnet = false
 TweenFarm(v.HumanoidRootPart.CFrame * MethodFarm)
 getgenv().atk = true
  StartMagnet = true
   
  until not getgenv().LevelFarm or not v.Parent or v.Humanoid.Health == 0 or not game.Workspace.Enemies:FindFirstChild(v.Name)
  getgenv().atk = false
  end
		end
    end
...
function checkquest2()
  if usequest and MyLevel > 29 and mylevel < 100 then 
   return true
 end
return false
end
...
function QuestCheck() 
    ...
    if OldWolrd then
        ...
        elseif MyLevel > 29 and MyLevel < 90 then 
         usequest = false
...
Info:AddLabel("Item: ")
local itemsts = Info:AddLabel(" - N/A")
local itemdo = Info:AddLabel("  + N/A")
 task.spawn(function()
   pcall(
    function()
     while wait() do 
      if getgenv().stus.item.first ~= nil then 
        itemsts:SetText(" - "..getgenv().stus.item.first)
        else 
         itemsts:SetText(" - N/A")
       end
      if getgenv().stus.item.aredo ~= nil then 
        itemdo:SetText("  + "..getgenv().stus.item.aredo)
        else 
         itemdo:SetText("  + N/A")
       end
            ...
            pcall(
                function()
                    for i, v in pairs(
                        ...
                        if v.Name == "Saber" then
                            getgenv().SwordInv.Saber = true
                            Saber:SetText("[+] : Saber")
                        end
                        if v.Name == "Rengoku" then
                            Rengoku:SetText("[+] : Rengoku")
                            getgenv().SwordInv.Rengoku = true
                        end
                        if v.Name == "Midnight Blade" then
                            MidnightBlade:SetText("[+] : Midnight Blade")
                            getgenv().SwordInv.MidnightBlade = true
                        end
                        if v.Name == "Dragon Trident" then
                            DragonTrident:SetText("[+] : Dragon Trident")
                            getgenv().SwordInv.DragonTrident = true
                        end
                        if v.Name == "Yama" then
                            Yama:SetText("[+] : Yama")
                        end
...
Library:SetWatermark('seraph [ver 0.0.1] - '..os.date ("%A, %m %B %Y"))
